...
class ReactTables extends React.Component {
  ...
  handleUpdateClick = () => {
    //alert("aqui vamos");
    const data = dataTableHalf.dataRows.map((prop, key) => {
      return {
        id: key,
        name: prop[0],
        position: prop[1],
    ...
    this.setState({ data: data });
    //const action = { type: 'setData' , value: data };
    const datios = "datos";
    this.props.dispatchSetData(datios);    
  }
...
const mapDispatchToPropsActions = dispatch => ({
  dispatchGetCourseList:() => dispatch(getCourseList())
});
