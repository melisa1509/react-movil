      ...
      <CardBody style={{ width: '800px', overflow: 'auto'}}>
            ...
            <GridContainer justify="center" className={classes.cardTitleCenter}>
              ...
              <svg width={330} height={330}>
                ...
                <polygon id="red_line" points={(form_programmbs !== undefined ? adjustCoordinates(form_programmbs.values.quality_q1) : "") + " "+ (form_programmbs !== undefined ? adjustCoordinates(form_programmbs.values.quality_q2) : "") + " "+ (form_programmbs !== undefined ? adjustCoordinates(form_programmbs.values.quality_q3) : "") + " "+ (form_programmbs !== undefined ? adjustCoordinates(form_programmbs.values.quality_q4) : "") + " "+ (form_programmbs !== undefined ? adjustCoordinates(form_programmbs.values.quality_q5) : "") + " "+ (form_programmbs !== undefined ? adjustCoordinates(form_programmbs.values.quality_q6) : "") + " "+ (form_programmbs !== undefined ? adjustCoordinates(form_programmbs.values.quality_q7) : "") + " "+ (form_programmbs !== undefined ? adjustCoordinates(form_programmbs.values.quality_q8) : "")} style={{
                      fill: 'none',
                      stroke: 'red',
                      strokeWidth: 3,
                      fillRule: 'evenodd'
