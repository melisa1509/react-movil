...
class PorcentageATable extends React.Component {
  ...
  render() {
    ...
    if (selected_ambassador == "ALL"){
      question = report_country.JR.map((prop)=>{
        let TableData=[]
        return(
      ...
      studentPre  = report_country.JR.map((prop)=>{
        let TableData=[]
        return(
      ...
      students  = report_country.JR.map((prop)=>{
        let TableData=[]
        return(
      ...
      percentagePre  = report_country.JR.map((prop)=>{
        let TableData=[]
        return(
      ...
      percentage = report_country.JR.map((prop)=>{
        let TableData=[]
        return(
    ...
    question = report_ambassador.JR.map((prop)=>{
      let TableData=[]
      return(
        TableData=[[t(prop.question)]]
      );
    });
    studentPre  = report_ambassador.JR.map((prop)=>{
      let TableData=[]
      return(
        TableData=[prop.studentsPre]
      );
    });
    students  = report_ambassador.JR.map((prop)=>{
      let TableData=[]
      return(
        TableData=[prop.students]
      );
    });
    percentagePre  = report_ambassador.JR.map((prop)=>{
      let TableData=[]
      return(
        TableData=[prop.percentagePre +"%"]
      );
    });
    percentage = report_ambassador.JR.map((prop)=>{
      let TableData=[]
      return(
        TableData=[prop.percentage +"%" ]
      );
