...
import { newProgramsa, saveProject } from "actions/programsaActions.jsx";
...
class Controls extends React.Component {
  ...
  handleSave(){
    this.props.dispatchNewProgramsa(this.props.history);
  }  
...
const mapDispatchToPropsActions = dispatch => ({
  dispatchNewProgramsa: param => dispatch( newProgramsa(param) ),  
